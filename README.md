...
`/` - [ImageInput](https://github.com/ISM-Lab2/skincare/blob/main/frontend/src/views/imageInput.jsx) 
...
`/form` - [Form](https://github.com/ISM-Lab2/skincare/blob/main/frontend/src/views/Form.jsx) 
...
`/recs` - [Recommendations](https://github.com/ISM-Lab2/skincare/blob/main/frontend/src/views/Recommendations.jsx) 
